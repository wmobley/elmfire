...
IF (IRANK_WORLD .EQ. PARALLEL_IO_RANK(3)) THEN
   PRINT *, 'Reading file: ', TRIM(WEATHER_DIRECTORY)//'/'//TRIM(WS_FILENAME)
...
IF (IRANK_WORLD .EQ. PARALLEL_IO_RANK(4)) THEN
   PRINT *, 'Reading file: ', TRIM(WEATHER_DIRECTORY)//'/'//TRIM(WD_FILENAME)
   CALL READ_BSQ_RASTER (WD,   WEATHER_DIRECTORY, WD_FILENAME)
ENDIF

IF (IRANK_WORLD .EQ. PARALLEL_IO_RANK(5)) THEN
   PRINT *, 'Reading file: ', TRIM(WEATHER_DIRECTORY)//'/'//TRIM(M1_FILENAME)
...
IF (IRANK_WORLD .EQ. PARALLEL_IO_RANK(6)) THEN
   PRINT *, 'Reading file: ', TRIM(WEATHER_DIRECTORY)//'/'//TRIM(M10_FILENAME)
...
IF (IRANK_WORLD .EQ. PARALLEL_IO_RANK(7)) THEN
   PRINT *, 'Reading file: ', TRIM(WEATHER_DIRECTORY)//'/'//TRIM(M100_FILENAME)
...
IF (USE_ERC .AND. IRANK_WORLD .EQ. PARALLEL_IO_RANK(8) ) THEN
   PRINT *, 'Reading file: ', TRIM(WEATHER_DIRECTORY)//'/'//TRIM(ERC_FILENAME)
...
IF (IRANK_WORLD .EQ. PARALLEL_IO_RANK(9)) THEN
   ...
   IF (CONSTANT_LH .GT. 0. ) THEN
      MLH%R4 (:,:,:) = CONSTANT_LH
   ELSE
      PRINT *, 'Reading file: ', TRIM(WEATHER_DIRECTORY)//'/'//TRIM(MLH_FILENAME)
...
IF (IRANK_WORLD .EQ. PARALLEL_IO_RANK(10)) THEN
   ...
   IF (CONSTANT_LW .GT. 0. ) THEN
      MLW%R4 (:,:,:) = CONSTANT_LW
   ELSE
      PRINT *, 'Reading file: ', TRIM(WEATHER_DIRECTORY)//'/'//TRIM(MLW_FILENAME)
...
IF (IRANK_WORLD .EQ. PARALLEL_IO_RANK(11)) THEN
   ...
   ELSE
      PRINT *, 'Reading file: ', TRIM(WEATHER_DIRECTORY)//'/'//TRIM(FMC_FILENAME)
...
INTEGER :: I, IOS, IBAND, IROW1, IROW2, IDUMMY, J
INTEGER*8 :: LRECL
...
! Print file name before reading BSQ raster
PRINT *, 'Reading BSQ raster file: ', TRIM(INDIR)//'/'//TRIM(FN)
