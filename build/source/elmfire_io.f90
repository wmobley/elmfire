...
print *, "scratch dir value: ", TRIM(SCRATCH)
...
! WRITE(*,*) 'Dumped HDR params: '
! WRITE(*,*) '    DESCRIPTION: ', DESCRIPTION
! WRITE(*,*) '    SAMPLES: ', SAMPLES
! WRITE(*,*) '    LINES: ', LINES
! WRITE(*,*) '    BANDS: ', BANDS
! WRITE(*,*) '    HEADER_OFFSET: ', HEADER_OFFSET
! WRITE(*,*) '    FILE_TYPE: ', FILE_TYPE
! WRITE(*,*) '    DATA_TYPE: ', DATA_TYPE
! WRITE(*,*) '    INTERLEAVE: ', INTERLEAVE
! WRITE(*,*) '    BYTE_ORDER: ', BYTE_ORDER
! WRITE(*,*) '    BAND_NAMES: ', BAND_NAMES
! WRITE(*,*) '    COORDINATE_SYSTEM: ', COORDINATE_SYSTEM
! WRITE(*,*) '    DATA_IGNORE_VALUE: ', DATA_IGNORE_VALUE
! WRITE(*,*) '    DEFAULT_BANDS: ', DEFAULT_BANDS
! WRITE(*,*) '    PROJECTION_NAME: ', PROJECTION_NAME
! WRITE(*,*) '    X_PIXEL_REFERENCE: ', X_PIXEL_REFERENCE
! WRITE(*,*) '    Y_PIXEL_REFERENCE: ', Y_PIXEL_REFERENCE
! WRITE(*,*) '    EASTING: ', EASTING
! WRITE(*,*) '    NORTHING: ', NORTHING
! WRITE(*,*) '    X_PIXEL_SIZE: ', X_PIXEL_SIZE
! WRITE(*,*) '    Y_PIXEL_SIZE: ', Y_PIXEL_SIZE
...
TYPE (RASTER_TYPE) :: RASTER
CHARACTER(400), INTENT (IN) :: INDIR,FN
CHARACTER(400) :: FNHDR, FNBSQ, FNTIF 
INTEGER :: IOS, IBAND, IROW1, IROW2
INTEGER*8 :: LRECL
REAL, ALLOCATABLE, DIMENSION(:) :: RVALUES
...
IF (DUMP_TOTAL_RAD_RECEIVED) THEN
   RDUMPME%R4(:,:,:) = RDUMPME%NODATA_VALUE
   C => LIST_TAGGED%HEAD
   DO I = 1, LIST_TAGGED%NUM_NODES
...
DO
   ...
   IF (IN_MULTILINE) THEN
      IF (INDEX(LINE, '}') > 0) THEN
         ...
         IN_MULTILINE = .FALSE.
         !CALL ASSIGN_VALUE(KEY, TRIM(MULTILINE_VALUE), MAP_INFO)
   ...
   ELSE
      ...
      IF (POS > 0) THEN
         ...
         ELSE IF (INDEX(CURRENT_VALUE, '{') > 0) THEN
            !CALL ASSIGN_VALUE(KEY, TRIM(VALUE(INDEX(VALUE, '{')+1:INDEX(VALUE, '}')-1)), MAP_INFO)
            CURRENT_VALUE = TRIM(CURRENT_VALUE(INDEX(CURRENT_VALUE, '{')+1:INDEX(CURRENT_VALUE, '}')-1))
         ENDIF
      ENDIF
   ENDIF

!   print *, "HDR line: ", TRIM(ADJUSTL(LINE)), "ENDLINE"
!   print *, "    HDR key: ", TRIM(ADJUSTL(KEY)), "ENDKEY"
!   print *, "    HDR value: ", TRIM(ADJUSTL(CURRENT_VALUE)), "ENDVALUE"
